...
function driverPoints() {
    const predictions = document.getElementById("predictionsForm")
    const qualifyPos = predictions.qualifyPos.value;
    const teammateQuali = predictions.teammateQuali.checked;
    const finishPos = predictions.finishPos.value;
    const teammatePos = predictions.teammateRace.checked;
    let runningTotal = 0
